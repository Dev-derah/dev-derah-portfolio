...
const Hero = () => (
  ...
  //   </motion.div>
  // </section>
  // <section className="py-2 sm:pl-16 pl-6 h-screen w-screen overflow-hidden relative">
  //   <motion.div
  //     variants={staggerContainer}
  //     initial="hidden"
  //     whileInView="show"
  ...
  //   <motion.div
  //     variants={slideIn('right', 'tween', 0.2, 1)}
  //     className="h-[90vh] w-screen md:-mt-[20px] -mt-[12px]"
  //   >
  ...
  //   <motion.div className="w-full flex justify-end sm:-mt-[70px] -mt-[50px] pr-[40px] absolute z-0 lg:mr-2">
  //     <img
  //       src="/stamp.png"
  //       alt="stamp"
  //       className="sm:w-[155px] w-[100px] sm:h-[155px] h-[100px] object-contain"
  ...
  >
    ...
    >
      ...
      <motion.div
        variants={slideIn('right', 'tween', 0.2, 1)}
        className="absolute h-[70vh] w-screen md:-mt-[20px] -mt-[12px] bottom-4 "
      >
